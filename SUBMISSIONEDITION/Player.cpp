...
// Player.cpp: This file contains all of the functions for Player.h
...
// Reads in sourceSheet with texture for player and checks if it worked
void Player::initTexture() {
  if (!this->sourceSheet.loadFromFile("person64.png"))
    std::cout << "ERROR IN PLAYER.CPP: Could not load player sheet!" << "\n";
}

// Initializes and sets the size of the first frame of the player sprite
void Player::initSprite() {
  ...
  this->model.setScale(1.05f, 1.05f); // How big the sprite is
}
