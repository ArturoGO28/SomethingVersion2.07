...
void Player2::initSprite() {
  ...
  this->currentFrame = sf::IntRect(0,0,64,64); // First frame size
  this->model.setTextureRect(this->currentFrame); //How much of the sheet we want to render.
  this->model.setScale(0.75f, 0.75f); // How big the sprite is
}
